...
const CACHE='biomedical-v1-branded-1';const FILES=['./','./index.html','./styles.css','./db.js','./app.js','./manifest.json','./biomedical-logo-original.png','./icon-192.png','./icon-512.png'];
