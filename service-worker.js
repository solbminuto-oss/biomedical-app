...
const CACHE='biomedical-v8-wounds-20260817-1';
const FILES=['./','./index.html','./styles.css','./config.js','./db.js','./api.js','./app.js','./manifest.json','./biomedical-logo-original.png','./icon-192.png','./icon-512.png'];
